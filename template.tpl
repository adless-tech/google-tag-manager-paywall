...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Custom Adless Integration",
  "categories": [
    "ADVERTISING",
    "SALES"
  ],
  ...
  "description": "Start earning with Adless in no time!\n\nThis is a general-purpose tag. Please consider our use-case specific tags for easy integration.\n\nSee https://adless.net/get-started/gtm for help getting started.",
  "containerContexts": [
    "WEB"
  ]
}
...
injectScript("https://static.adless.net/adless.js", () => {
    ...
    cfg.services = data.services ? data.services.map(s => s.id) : [];
